...
import SearchGridItem from '.'

export default {
  component: SearchGridItem,
  title: 'components/interactives/GridSection/SearchGridItem',
}

const Template = (args) => <SearchGridItem {...args} />
...
// Media Item
export const MediaItem = Template.bind({})
MediaItem.args = { item: mediaItem }
MediaItem.storyName = 'Media Item'

// Article Item
export const ArticleItem = Template.bind({})
ArticleItem.args = { item: articleItem, submedia: false }
ArticleItem.storyName = 'Article Item'

// Submedia Article Item
export const SubArticleItem = Template.bind({})
SubArticleItem.args = { item: articleItem, submedia: true }
SubArticleItem.storyName = 'Submedia Article Item'
