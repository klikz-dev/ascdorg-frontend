...
import SearchGridSectionItems from '.'

export default {
  component: SearchGridSectionItems,
  title: 'components/interactives/GridSection/SearchGridSectionItems',
}

const Template = (args) => <SearchGridSectionItems {...args} />
...
// With hits
export const Hits = Template.bind({})
Hits.args = {
  hits,
}
Hits.storyName = 'With Hits'
